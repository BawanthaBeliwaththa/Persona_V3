...
## 1. Executive Summary
Persona is a full-stack LinkedIn profile intelligence platform designed to automate the discovery, extraction, ranking, and export of LinkedIn profile data. By influencing real browser automation (Chromium via Playwright), Persona bypasses traditional scraping limitations, extracting , structured data directly from LinkedIn's detailed sub-pages. The system includes an Admin Dashboard for task coordianation and a Client Portal for end-user data consumption.

## 2. Project Objectives
- **Automated Data Extraction:** Seamlessly navigate and extract structured data from LinkedIn profiles without doing it manually.
- **Deep Scraping:** Visit dedicated detail pages (e.g., `/details/experience`, `/details/education`) to bypass UI reduction on the main profile page.
